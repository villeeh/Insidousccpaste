...
void grenade_prediction::Paint()
{
	...
	if ((type) && path.size()>1)
	{
		...
		{
			g_Surface->DrawSetColor(Color(int(g_Options.Colors.GrenadePredEnd[0] * 255), int(g_Options.Colors.GrenadePredEnd[1] * 255), int(g_Options.Colors.GrenadePredEnd[2] * 255), 255));
