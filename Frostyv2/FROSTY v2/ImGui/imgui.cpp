...
ImGuiStyle::ImGuiStyle()
{
	...
	Colors[ImGuiCol_FrameBg] = ImVec4(0.80f, 0.50f, 0.50f, 1.00f);  // Background of checkbox, radio button, plot, slider, text input
	...
	Colors[ImGuiCol_CheckMark] = ImVec4(0.26f, 0.59f, 0.98f, 0.40f);
...
bool ImGui::RadioButton(const char* label, bool active)
{
	...
	if (active)
	{
		...
		window->DrawList->AddCircleFilled(center, radius - pad, GetColorU32(ImGuiCol_CheckMark), 25);
	}
